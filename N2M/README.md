...
Source: [https://github.com/clvrai/N2M](https://github.com/clvrai/N2M)  
Source commit: `202bb592cd20d1170fa4af33e5eb14bfd7fba88b`

Run the installation, training, and evaluation commands from this `N2M/` directory. This directory contains a snapshot of the upstream default branch. Refer to the upstream repository for subsequent updates and the separate `sim` and `real` branches.
