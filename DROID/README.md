...
Source: [https://github.com/droid-dataset/droid_policy_learning](https://github.com/droid-dataset/droid_policy_learning)  
Source commit: `9a29c832b4c81bf38401111f5e4cdddaca217581`

Run the installation, training, and evaluation commands from this `DROID/` directory. This directory contains a snapshot of the upstream default branch. Refer to the upstream repository for subsequent updates.
